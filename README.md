...
//  O --> R{Frequency & Cross-tabulation (Bar Chart)};
//  O --> S(3.2. Correlation Analysis);
//  O --> U(3.3. Comparative Analysis);
//  O --> V{Paired Samples T-Test (Table, Box Plot)};
//  O --> W{Independent Samples T-Test (Table, Box Plot)};
//
...
//  BB --> EE{Hypothesis Test Results (Table)};
//
